...
Program::Program(const Shader& vertex, const Shader& fragment) {
    ...
    if (vertex.getType() != ShaderType::VERTEX || fragment.getType() != ShaderType::FRAGMENT)
...
void Program::setUniform3f(const char* name, const float& value1, const float& value2, const float& value3) {
    glUniform3f(glGetUniformLocation(GLObject::getId(), name), value1, value2, value3);
}

void Program::setUniform4f(const char* name, const float& value1, const float& value2, const float& value3, const float& value4) {
    glUniform4f(glGetUniformLocation(GLObject::getId(), name), value1, value2, value3, value4);
}
...
void Program::setUniformMat4f(const char* name, glm::mat4 value) {
    glUniformMatrix4fv(glGetUniformLocation(GLObject::getId(), name), 1, GL_FALSE, glm::value_ptr(value));
}